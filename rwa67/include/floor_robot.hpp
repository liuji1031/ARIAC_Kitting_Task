...
#include <custom_msgs/srv/placing_part.hpp>
#include <custom_msgs/srv/placing_tray.hpp>
#include <custom_msgs/msg/part_delivery.hpp>
#include <custom_msgs/srv/pickup_part.hpp>
#include "custom_msgs/srv/remove_part.hpp"
...
private:
    ...
    */
    ...
    rclcpp::CallbackGroup::SharedPtr server_cbg_;
    ...
    //! Service to place the tray robot's carrying on agv
    rclcpp::Service<custom_msgs::srv::PlacingTray>::SharedPtr place_tray_on_agv_srv_;
    //! Service to pickup the part
    rclcpp::Service<custom_msgs::srv::PickupPart>::SharedPtr pickup_part_srv_;
    //! Service to place the part robot's carrying on the tray sitting on agv
    rclcpp::Service<custom_msgs::srv::PlacingPart>::SharedPtr place_part_on_tray_srv_;
    ...
    //! Service to remove a faulty part from the agv
    rclcpp::Service<custom_msgs::srv::RemovePart>::SharedPtr remove_part_srv_;
    ...
    /**
     * @brief Callback function for the service /commander/place_tray_on_agv
     * 
     * @param req_ Shared pointer to custom_msgs::srv::PlacingTray::Request
     * @param res_ Shared pointer to custom_msgs::srv::PlacingTray::Response
     */
    void
    pickup_part_cb_(
        custom_msgs::srv::PickupPart::Request::SharedPtr req_, custom_msgs::srv::PickupPart::Response::SharedPtr res_);
    
    /**
     * @brief Callback function for the service /custom_msgs/pickup_part
     * 
     * @param req_ Shared pointer to custom_msgs::srv::PlacingTray::Request
     * @param res_ Shared pointer to custom_msgs::srv::PlacingTray::Response
     */

    void place_tray_on_agv_cb_(
        custom_msgs::srv::PlacingTray::Request::SharedPtr req_, custom_msgs::srv::PlacingTray::Response::SharedPtr res_); 

    /**
     * @brief Callback function for the service /commander/place_part_on_tray
     * 
     * @param req_ Shared pointer to custom_msgs::srv::PlacingPart::Request
     * @param res_ Shared pointer to custom_msgs::srv::PlacingPart::Response
     */
    void place_part_on_tray_cb_(
        custom_msgs::srv::PlacingPart::Request::SharedPtr req_, custom_msgs::srv::PlacingPart::Response::SharedPtr res_); 
    /**
    ...
    bool pickup_part(geometry_msgs::msg::Pose &part_pose_, int part_type_, int part_color_);
     ...
     */
    bool place_tray_(int tray_id, int agv_num);
    //-----------------------------//
     ...
     */
    bool place_part_on_tray_(int agv_num, int quadrant);
    //-----------------------------//
     ...
     */
    void wait_for_attach_completion_(double timeout, double dz=0.001);
    //-----------------------------//
    ...
    /**
     * @brief remove a faulty part from the agv
     * 
     * @param agv_num the agv from which to remove part
     * @param quadrant the quadrant of the part
     * @return true if successful
     * @return false if failed
     */
    bool remove_part_from_tray_(int agv_num, int quadrant, int part_type, int part_color);
    ...
    */
    ...
    std::map<std::string, double> floor_kts2_js_ = {
        ...
        {"floor_wrist_3_joint", 0.0}};
    //! Joint value targets for kit tray station 2
    std::map<std::string, double> drop_disposal_js_ = {
        {"linear_actuator_joint", -0.19},
        {"floor_shoulder_pan_joint", 0.0},
        {"floor_shoulder_lift_joint", -0.628},
        {"floor_elbow_joint", 1.63},
        {"floor_wrist_1_joint", -2.51},
        {"floor_wrist_2_joint", 4.66},
        {"floor_wrist_3_joint", 0.0}};    
